...
record a webpage while scrolling
capture frames from the recording
upload frames to Gemini AI
retrieve structured results such as JSON
Advantages:
...
request extraction of specific fields
receive structured output such as JSON
Conceptual example:
